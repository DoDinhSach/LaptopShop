...
public class GioHangDao {
    ...
    public ArrayList<GioHangItem> getCartItems(long userId) {
    ...
    public int getTotal(long userId) {
        int total = 0;
        for (GioHangItem it : getCartItems(userId)) total += it.thanhTien();
        return total;
    }

    public ArrayList<GioHangItem> getCartItemsByIds(long userId, List<Long> cartItemIds) {
        ArrayList<GioHangItem> list = new ArrayList<>();
    ...
    public int getTotalByIds(long userId, List<Long> cartItemIds) {
        int total = 0;
        for (GioHangItem it : getCartItemsByIds(userId, cartItemIds)) total += it.thanhTien();
        return total;
    }
    ...
    private GioHangItem readCartItem(Cursor c) {
        GioHangItem it = new GioHangItem();
        it.id = c.getLong(0);
