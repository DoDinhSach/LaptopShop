...
import com.example.laptopshop.data.model.Product;

import java.util.ArrayList;
import java.util.HashMap;

public class ProductDao {
// ProductDao là file làm việc với dữ liệu sản phẩm trong SQLite.
    // hộp điều kiện lọc
    ...
    public ArrayList<Product> locSanPham(ProductFilter filter) {
        ...
        ArrayList<String> args = new ArrayList<>(); // ds giá trị truyền vào dấu ?
        ArrayList<String> conditions = new ArrayList<>(); // ds các đk SQL
...
// Ghép điều kiện và gọi truy vấn
...
// Hàm này chuyển lựa chọn sắp xếp thành câu order by
...
// chuyển dữ liệu database thành object
