...
import com.example.laptopshop.ui.orders.OrderDetailActivity;
...
public class AdminHomeActivity extends BaseHomeActivity {
    ...
    private void loadDashboardData() {
        if (donHangDao == null || sanPhamDao == null || nguoiDungDao == null) return;

        ArrayList<DonHang> orders = donHangDao.getAllOrders();
        ArrayList<SanPham> products = sanPhamDao.layTatCa();
        ArrayList<DonHangDao.MonthRevenue> revenueByMonth = donHangDao.getDoanhThuTheoThang(Calendar.getInstance().get(Calendar.YEAR));
    ...
    private void bindKpis(ArrayList<DonHang> orders, ArrayList<SanPham> products, ArrayList<DonHangDao.MonthRevenue> revenueByMonth) {
        ...
        int monthRevenue = 0;
        for (DonHangDao.MonthRevenue item : revenueByMonth) {
        ...
        tvCustomersCount.setText(String.valueOf(nguoiDungDao.getCustomerCount()));
    ...
    private void bindRevenueChart(ArrayList<DonHangDao.MonthRevenue> revenueByMonth) {
    ...
    private void bindRecentOrders(ArrayList<DonHang> orders) {
