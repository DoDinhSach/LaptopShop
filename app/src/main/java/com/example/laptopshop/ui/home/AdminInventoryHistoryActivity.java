...
import com.example.laptopshop.data.model.InventoryHistoryEntry;
...
public class AdminInventoryHistoryActivity extends BaseHomeActivity {
    ...
    private ArrayList<SanPham> products = new ArrayList<>();
    ...
    private void setupFilters() {
        if (sanPhamDao == null || spProduct == null || spType == null) return;
    ...
    private void loadData() {
        if (historyDao == null || adapter == null) return;
    ...
    private void enrichStockAfter(ArrayList<InventoryHistoryEntry> list) {
        ...
        HashMap<Long, Integer> runningStock = sanPhamDao.getCurrentStockMap(true);
        for (InventoryHistoryEntry entry : list) {
