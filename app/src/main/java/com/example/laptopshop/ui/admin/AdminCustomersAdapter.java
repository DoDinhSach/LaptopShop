...
public class AdminCustomersAdapter extends RecyclerView.Adapter<AdminCustomersAdapter.VH> {
    ...
    public interface Listener {
        void onClick(NguoiDung user);
        void onEdit(NguoiDung user);
        void onDelete(NguoiDung user);
    }

    private final ArrayList<NguoiDung> data = new ArrayList<>();
    ...
    public void setData(ArrayList<NguoiDung> list) {
        data.clear();
